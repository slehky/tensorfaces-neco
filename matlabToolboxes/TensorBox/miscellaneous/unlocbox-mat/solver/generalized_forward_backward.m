function [sol, infos,objectiv] = generalized_forward_backward(x_0, F, f , param)
...
%          [sol,infos,objectiv] = generalized_forward_backward(...);
%
%   Input parameters:
...
while 1
    ...
    for ii=1:length(F)
       temp=2*sol-reshape(z(ii,:,:),size(x_0))-param.lambda*grad(sol);
