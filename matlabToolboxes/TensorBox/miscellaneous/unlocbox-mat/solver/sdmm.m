...
[~,~,prev_norm,iter,objectiv,~] = convergence_test(gen_norm(x_n,F));

% Main loop
for kiter = 1:param.maxit
    ...
    [~,rel_norm,prev_norm,iter,objectiv,crit] = convergence_test(curr_norm,prev_norm,iter,objectiv,param);
