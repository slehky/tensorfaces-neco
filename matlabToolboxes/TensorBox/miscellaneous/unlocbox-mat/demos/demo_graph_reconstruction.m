...
param.max_iter=20; % maximum iteration
param.epsilon=10e-5; % tolerance to stop iterating
param.gamma=0.5; % stepsize (beta is equal to 2)
param.method='ISTA'; % desired method for solving the problem
...
%% solve the problem
sol=forward_backward(depleted_graph_value,f1,f2,param);
