...
%    DEMO_COMPRESS_SENSING -  Solve a compress sensing problem using forward_backward 
%    DEMO_COMPRESS_SENSING2 -  Solve a compress sensing problem using Douglas Rachford
%    DEMO_COMPRESS_SENSING3 -  Solve a compress sensing problem using grouped L12 norm
%    DEMO_COMPRESS_SENSING4 -  Solve a compress sensing problem using grouped L1inf norm
%    DEMO_DECONVOLUTION     -  Deblur an image by solving a deconvolution algorithm
%    DEMO_GRAPH_RECONSTRUCTION - Reconstruct missing values on a graph signal
%    DEMO_SOUND_RECONSTRUCTION - Reconstruct missing part of a sound
