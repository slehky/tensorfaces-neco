function [sol,infos] = prox_l12(x, gamma , param)
%PROX_L12 Proximal operator with L12 norm
%   Usage:  sol=prox_l12(x, gamma, param)
%           [sol,infos] = prox_l12(x, gamma, param)
%
%   Input parameters:
%         x     : Input signal.
...
%
%      sol = argmin_{z} 0.5*||x - z||_2^2 + gamma * ||A x||_12
%
%
%   param is a Matlab structure containing the following fields:
%
%    param.weights1 : weights for a weighted L12-norm works on the norm L1 (default = 1)
%
%    param.weights2 : weights for a weighted L12-norm works on the norm L2 (default = 1)
%
...
%
%
%   See also:  prox_l1 prox_l1inf proj_b1 prox_sumg
%
...
if param.multi_group==0
    ...
    norm_L12=norm_l12(x,param.g_d,param.g_t,param.weights2,param.weights1);
...
infos.iter=iter;
infos.final_eval=norm_l12(sol,param.g_d,param.g_t);
infos.crit=crit;
infos.time=toc(t1);
